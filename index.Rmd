--- 
title: "Quantifying synchrony and variability in source water quality across a relatively undisturbed nested catchment: contributions to characterizing a protected water supply area to better understand how forest management strategies influence drinking water treatability and outcomes"
...
```{r index setup, warning = FALSE, message = FALSE, include = FALSE}
...
To Stack Overflow, forWater, Tight Club Athletics, and to each person who reads this thesis in its entirety.