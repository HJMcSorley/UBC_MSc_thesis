...
knitr::include_graphics("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplot_all.png")
```
...
Variables were grouped and each group was evaluated independently (Figure \@ref(fig:groupedRF))... which agreed//?

\  

```{r groupedRF, fig.cap = fig_cap}
...
knitr::include_graphics("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplots_variable-groups.png")
```
