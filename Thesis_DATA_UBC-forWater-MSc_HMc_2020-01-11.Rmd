...
#---- samples were collected from a total of 30 sites (including lab), 6 were permanent installations ---- #
...
# read in all the files (trips 2-8)
spectrolyser_results <- list.files(path = resultsdata_path_scan, pattern = c("*.par", "*.txt")) %>% 
