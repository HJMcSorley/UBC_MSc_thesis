...
sixsites_samplecount_df <- sixfilter %>% 
  ...
  knitr::kable(., caption = "Installation sites sample counts", col.names = c("installation site", "sample type", "number of samples"))
...
## 215 synoptic grab samples 
# 6 installation sites
## 285 samples were collected/analyzed at the 6 installation sites:
### 171 rack samples 
### 114 grab samples
# an additional 14 grab samples were collected (synoptically) but as one-offs (totaling 229 grabs overall)
...
# I don't think this is a good graphic
