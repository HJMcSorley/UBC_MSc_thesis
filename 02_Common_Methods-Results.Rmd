...
fig_cap = "\\label{fig:meanWxLWSA} Mean daily air temperature, rain and accumulated snow from Chris Creek (560 m a.s.l) and Martin's Gulch (512 m a.s.l) fire-weather stations in the Leech Water Supply Area, where the coloured sections following the dashed 'Project Start' line indicate data from the study period."
...
A challenge of Vertical Rack sampling is rapid retrieval of collected samples; delays may arise due to logistics of field access and high water can prohibit safe access to the Rack. Sample hold-times were determined and applied as quality assurance in data analysis. Continuously recorded stage data was coupled with manually recorded siphon-bottle heights to determine date-times of sample collection and to calculate Rack sample hold-times, which were used to flag and filter data.
