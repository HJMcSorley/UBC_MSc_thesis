...
RF_DOC_allChrc_RelImp1_MSE <- randomForest::importance(DOC_allVars_RF, type = 1) %>% 
  ...
  mutate(predictor = fct_recode(predictor,
                                ...
                                "Sample Hold-time" = "HoldTime_days",
...
cowplot::plot_grid(RFplot_all_DOC, 
                   ...
                   ncol = 1, rel_heights = c(2, 1.4, 1.4) )
...
# 3 DOC with metamorphic parent material
...
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch4_RF_DOC-predictor-3-gneiss.png",
       width = 4, height = 4, units = "in")
...
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch4_RF_DOC-predictor-4-slope.png",
       width = 4, height = 4, units = "in")
