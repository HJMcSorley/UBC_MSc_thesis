...
# save plot
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Wx_LWSA-means.png", width = 5, height = 4, units = "in")
```
...
## Ch3 sample stage, rain events, seasons
```{r}
...
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_StageNorm_DOC-NOM.png",
       width = 6, height = 7.5, units = "in")
