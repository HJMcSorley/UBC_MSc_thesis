...
synopticfilter %>%
  ...
  scale_x_datetime(date_labels = "%Y %b %d", date_breaks = "2 months", date_minor_breaks = "1 months") 
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/CH2_DOC-loess-trend.png", width = 6, height = 4, units = "in")
...
d <- synopticfilter %>%
  ...
  scale_x_datetime(date_labels = "%Y %b %d", date_breaks = "2 months", date_minor_breaks = "1 months")
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/CH2_E2E3-loess-trend.png", width = 6, height = 4, units = "in")
