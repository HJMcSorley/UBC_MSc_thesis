...
### Ch3 sample stage with rain events
```{r}
# --- river sample plot
...
stg_sample_plot <- stage_samples %>% 
  ...
  geom_vline(colour = "#0072B2", linetype = "twodash", 
             xintercept = c(event_starts), size = 0.5, show.legend = TRUE)+ #forWater_colours1["MainBlue"]
  # river stage
...
# add rain 
cowplot::plot_grid(subbasin_meanrain_plot, stg_sample_plot, ncol = 1, align = "v",
                   rel_heights = c(1,7))
# save 
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_Wx-stage-subbasins_megaplot_sampletype.png",
         width = 6, height = 7.5, units = "in")
```


## Ch2 Seasonal megaplot
```{r}
...
boxplots of G/R wet season only  
```{r}
