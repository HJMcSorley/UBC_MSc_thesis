...
AllVariables_E2E3 <- sixfilter_physiographic %>% 
  ...
  select(c(E2E3, # predict E2E3
           ...
           antecedent_30day_rain, # relatively more important than 7-day 
           # antecedent_7day_rain,
           antecedent_7day_temp, # relatively more important than 30-day
           # antecedent_30day_temp,
           HoldTime_days,
           geo_metamorphic_percent,
           #geo_metasedimentary_percent, 
           #geo_metaSedimentaryVolcanic_percent, 
           #geo_igneous_percent,
           # rain_season, # correlated with temp
           drainage_area_km2, 
           slope_med_degrees,
           forest_percent, # correlated with wetland and open water (all land-cover)
           logging_percent_FROMnineteeneightyTOtwentyeleven = "logging_percent_nineteeneighty-twentyeleven" )) # %>%     
...
# stack DOC and E2E3 plots
cowplot::plot_grid(RFplot_all_DOC, (
  RFplot_all_E2E3 + 
    theme(legend.position = "none") ),
  ncol = 1, rel_heights = c(2, 1.4) )
 
# save 
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplot-summary_DOC-E2E3.png", 
