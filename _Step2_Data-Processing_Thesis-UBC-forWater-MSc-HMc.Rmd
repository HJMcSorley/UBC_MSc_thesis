...
# save plot 
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_DOCvsTemp.png", width = 6, height = 4, units = "in")
...
a <- sixfilter %>%
  ...
  labs(y = "", x = "DOC (mg/L)", subtitle = "A) NOM Concentration")
...
b <- sixfilter %>%
  ...
  labs(y = "", x = expression(SAC[254]~(m^-1)), subtitle = "B) NOM Character" )
