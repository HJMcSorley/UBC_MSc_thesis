...
AllVariables_NPOC <- sixfilter_physiographic %>% 
  ...
  select(c(NPOC_ppm, # predict DOC
           ...
           antecedent_30day_rain, # relatively more important than 7-day 
...
RF_DOC_allChrc_RelImp1_MSE <- randomForest::importance(DOC_allVars_RF, type = 1) %>% 
  ...
  mutate(predictor = fct_recode(predictor,
                                ...
                                "antecedent 30-day air temp" = "antecedent_30day_temp",
  ...
  mutate(variable_group = case_when(
    ...
    predictor == "rain event number" | 
       ...
       predictor == "antecedent 30-day air temp" |
       predictor == "antecedent 7-day rain" |
      predictor == "antecedent 30-day rain" | 
       predictor == "Hold-time days" | 
       predictor == "sampling stage" ~ "Conditions",
    # surface characteristics
    predictor == "rain season" | 
       predictor ==  "darainage area" | 
       predictor == "sample site elevation" | 
       predictor == "forest cover" | 
       #predictor == "wetland cover" | 
       #predictor == "open water" | 
    ...
    predictor == "metamorphic (%)" | 
       predictor == "meta-sedimentary (%)" | 
       predictor == "meta-sedimentary-volcanic (%)" | 
...
# VIM plot
RFplot_all <- RF_DOC_allChrc_RelImp1_MSE %>% 
  ...
  labs(y = "variable importance in predicting DOC (%)", x = "", fill = "Predictor variable group") +
...
RFplot_all_E2E3 <- RF_E2E3_allChrc_RelImp1_MSE %>% 
  ...
  theme_bw() +
  theme(legend.position = "top", text = element_text(size = 11))+
  labs(y = "variable importance in predicting E2:E3 (%)", x = "", fill = "Predictor variable group") +
  guides(fill = guide_legend(nrow = 3, byrow=TRUE))
...
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplots_variable-groups_DOC.png", 
       width = 6, height = 5, units = "in")

# add with all?
bigboi <- cowplot::plot_grid(RFplot_all, RFplot_summary, ncol = 2)

# save for landscape page layout
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplot_summary-by_variable-groups_DOC.png", 
...
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplots_variable-groups_E2E3.png", 
       width = 6, height = 5, units = "in")
...
# save for landscape page layout
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RFplot_summary-by_variable-groups_E2E3.png", 
       width = 9, height = 6, units = "in")
