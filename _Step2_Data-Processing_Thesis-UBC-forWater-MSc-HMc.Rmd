...
sixfilter_physiographic <- left_join(sixfilter_RF, physiographic, by = c("site")) %>%
  ...
  select(c(site, DateTime_sampled, HoldTime_days, 
           NPOC_ppm, rain_season, sampleStage_normalized, 
           antecedent_7day_rain, antecedent_7day_temp, 
           latitude, longitude, strahler_order, 
           drainage_area_km2, elevation_masl, 
           forest_percent, wetland_percent, openWater_percent, 
           geo_WarkGneiss_percent, geo_metamorphic_percent,
           geo_ArgilliteMetagreywacke_percent, geo_Metagreywacke_percent,
           geo_metasedimentary_percent, geo_ChertArgilliteVolcanic_percent,
           geo_metaSedimentaryVolcanic_percent, geo_MetchosinVolcanics_percent,
           geo_SookeGabbro_percent, geo_igneous_percent, 
           slope_med_degrees, slope_max_degrees,
...
RF_sixPhysiog_select <- RF_sixPhysiog %>% 
  select(-c(HoldTime_days,
           #antecedent_7day_rain, # strongly correlated to stage (but not necessarily sampling stage?) 
...
RF_plot_relimp_MSE <- randomForest::importance(RF_NPOC, type = 1) %>% 
  ...
  mutate(predictor = fct_recode(predictor,
                                ...
                                "antecedent 7-day rain" = "antecedent_7day_rain",
...
# save it
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RF_NPOC-type1-relimp_MSE.png", 
       width = 6, height = 5, units = "in")
...
# save this one too 
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3A_RF_NPOC-type2-relimp_RSS.png",
       width = 6, height = 5, units = "in")
...
# save it
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RF_NPOC_type1-wet-relimp_MSE.png", 
       width = 6, height = 5, units = "in")
...
RF_plot_relimp_RSE <- randomForest::importance(RF_NPOC_wet, type = 2) %>% 
  ...
  labs(y = "variable importance (%)", x = "", size = 12 )
# save it
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3A_RF_NPOC_type2-wet-relimp_RSS.png", 
       width = 6, height = 5, units = "in")
...
RF_plot_relimp_MSE <- randomForest::importance(RF_NPOC_dry, type = 1) %>% 
  ...
  geom_bar(stat = "identity", position = "dodge",
           colour = forWater_colours2["Gray"], 
           fill = forWater_colours2["MyOrange"],
           alpha = 0.8) +
  theme_bw() +
  labs(y = "variable importance (%)", x = "", size = 12)

# save it
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3_RF_NPOC_type1-dry-relimp_MSE.png", 
       width = 6, height = 5, units = "in")
...
# save it
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/Ch3A_RF_NPOC_type2-dry-relimp_RSS.png", 
       width = 6, height = 5, units = "in")
