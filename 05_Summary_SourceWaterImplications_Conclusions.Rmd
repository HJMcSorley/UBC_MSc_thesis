...
This chapter summarizes results from Chapters two to four, and discusses them in context of a forested drinking water supply with interpretation of watershed attributes and environmental conditions. Results are discussed through the lens of supplemental source drinking water and treatability.   

### Synopsis of results

Stream water samples were collected from across the Greater Victoria Water Supply Area (GVWSA) and aqueous natural organic matter (NOM) was evaluated for quantity and quality. Natural organic matter (NOM) is a complex assembly of carbon-based molecules. The complicated medley that comprises NOM can be estimated by quantifying the organic carbon that forms its backbone. The molecular structure of NOM can vary from large, highly aromatic compounds to smaller aliphatic molecules and differences can be attributed to the NOM source. Terrestrial humic substances (i.e. allochthonous NOM) tends to be higher molecular weight, larger and more aromatic in structure; while NOM from in-stream sources such as algae (i.e. autochthonous NOM) is typically less aromatic, more aliphatic and protein-like in structure. The quantity of aqueous NOM was assessed as the concentration of dissolved organic carbon (DOC) in each sample. The molecular quality of NOM was measured by UV-Vis spectrophotometry; the specific absorbance coefficient at 254 nm (SAC~254~) was used as an indicator of NOM molecular aromaticity and reactivity [@Weishaar2003; @Vidon2008; @Abbott2018], and the quotient of SAC at 250 nm and 365 nm (E~2~:E~3~) was used to indicate (inversely) aromaticity and molecular size of aquatic humic solutes [@Peuravuori1997; @Helms2008].

\    

The quantity and quality of NOM vary over space and time, and understanding the spatiotemporal patterns of concentrations and character can help to inform source drinking water management decisions and can provide information about watershed science with respect to the origins, transport and fate of aqueous parameters. Vertical Racks for passive event sampling were coupled with synoptic Grab sampling campaigns to measuring water quality changes over time, through events, and across the GVWSA. A challenge of Vertical Rack sampling is that high water can prohibit safe retrieval of collected samples from the Racks. Coupling continuously recorded stage with manually recorded siphon bottle heights allowed for calculation of sample hold-times and quality control measures for samples that had exceeded an acceptable holding time. Siphon sampling by Vertical Racks is currently limited to the rising hydrograph limb, but the combination of Grab and Rack sampling can achieve good representation across the hydrograph.

\  

#### Spatiotemporal dynamics in the quantity and quality of NOM

The sampling period spanned sixteen months, from October 2018 to February 2020. Seasons were defined as 'wet' (fall/winter/spring) and 'dry' (summer) and were distinguished by the activity of passive Vertical Rack sample collection. The wet season included conditions that triggered rising stage sample collection by generating event responses in each of the six Leech WSA monitoring site streams. Sampling began after the start of the 2018/2019 wet season, which extended until mid-May 2019. The 2019 dry season spanned from mid-May to late September 2019, when the 2019/2020 wet season began. Based on this definition of seasons Vertical Rack samples were only collected in the wet season, while Grab samples were collected throughout the entire sampling period. 



\  

Results from twelve synoptically sampled sites across the GVWSA were used to assess broad spatial and temporal patterns in stream NOM dynamics. And a more in-depth analysis was completed for six of those sites equipped with vertical sampling racks.   

Spatial NOM patters showed greater concentrations of more aromatic NOM in sub-basins draining the west of the GVWSA, with lower concentrations of less aromatic NOM in basins draining from the east. Higher concentrations were generally found in headwaters, though the patterns of upstream-to-downstream NOM quality changed between seasons. 
