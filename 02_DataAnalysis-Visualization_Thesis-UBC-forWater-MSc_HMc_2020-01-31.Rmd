...
```{r sample_type ridge plots, results='hide'}
# density ridge 
# wrap by sample_type
...
Four hundred water sample were collected and analyzed for DOC over a 16 month study period (October 2018 to February 2020). The synoptic grab-sampling program was enhanced by collection of stormflow on the six vertical sampling racks. In total, 171 samples were collected on vertical Racks, 215 Grab samples were collected at 15 synoptically sampled sites (which included the six installation sites), and an additional 14 Grab samples were collected opportunisitcally at one-off sites across the water supply area. Figure 3 shows DOC concentrations across the 15 synoptically sampled sites over the study period: DOC concentrations decreased throughout the wet season, and increased again during the dry summer months.
...
Figure 4 shows DOC concentrations over the study period at each of the six installation locations in the LWSA.
...
While DOC concentrations generally increased during stormflow (relative to between-storm peaks) in the wet season {_data not shown here_}, the dry season (summer) baseflow conditions showed elevated levels of DOC compared to wet season DOC (Fig.5).
...
At each of the six sub-basin monitoring locations, mean DOC was higher during the dry season than during the wet season. There was less variation in dry season DOC concentrations at each site also, which could be due to actual reduction in variance in the absence of stormflow pulses and also due to fewer dry season samples (n = 46) compared to wet season samples (n = 278). 
...
To remove the variance of stormflow DOC concentrations, Table 2-B shows seasonal concentrations based only on Grab samples (excludes 166 stormflow samples collected by Racks).
...
```{r seasonal boxplots, results='hide'}
...
```{r SUVA plots -- in progress, results='hide'}
