...
sampleresults_grab <- sampleresults_grabstage %>% 
  ...
  select(-c(sampleStage_cm.x, sampleStage_cm.y, DateTime_R, dt_sampled))
# DateTime and sampleStage_cm are the good good

# check it out
str(sampleresults_grab)
...
results <- full_join(sampleresults_grab, sampleresults_rack, 
                 by = c("site", "trip", "sample_type", "sample", "DateTime", "dt_sampled", "sampleStage_cm", "NPOC_ppm", "analysis", "NPOC_ppm"))
...
# might not need what's below here...
...
sixfilter <- results %>% filter(site == "Weeks" |
                                        site == "LeechHead" |
                                        site == "ChrisCrk" |
                                        site == "CraggCrk" |
                                        site == "WestLeech"| 
...
stg_sample <- left_join(corr_stage, (sixfilter %>% 
