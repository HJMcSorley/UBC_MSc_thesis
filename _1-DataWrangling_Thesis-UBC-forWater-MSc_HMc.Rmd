...
spectral slopes are weird and I don't understand them. An alternative is A250:A365 ("E2:E3") (below)
```{r}
...
spectral_summary <- spectral_results %>%
  ...
  mutate(SlopeRatio = sample_slope1/sample_slope2,
         E2E3 = Abs_250/Abs_365, # akak A~250:A~365
         E4E6 = Abs_465/Abs_665, # humification indicator
         trip = as_factor(trip)) %>% 
...
# YOU ARE HERE
you just updated the indices above... pseudo SUVA254 could be better... but your brain stopped working. YOU HAVE A LOT TO DO!!!!
...
# add a HoldTime_span for period each rack sample sat on the rack before collection
results <- results %>% 
