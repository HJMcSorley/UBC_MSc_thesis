...
# WIP Match bottle height to logged stage

GOAL: for each Rack sample in each event find the first DateTime occurance at which logged stage was equal to or greater than the fill_stage for each bottle
...
3. filter by site/source & sample_type (== "Rack") & event/interval & analysis (DOC)
