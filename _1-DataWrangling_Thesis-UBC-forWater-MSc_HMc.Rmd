...
stg_sample <- stg_sample %>%
  mutate(event_ID =
             case_when(
    DateTime %within% interval(events$StartDate[1], events$StartDate[2]) ~ events$ID[1],
    DateTime %within% interval(events$StartDate[2], events$StartDate[3]) ~ events$ID[2],
    DateTime %within% interval(events$StartDate[3], events$StartDate[4]) ~ events$ID[3],
    DateTime %within% interval(events$StartDate[4], events$StartDate[5]) ~ events$ID[4],
    DateTime %within% interval(events$StartDate[5], events$StartDate[6]) ~ events$ID[5],
    DateTime %within% interval(events$StartDate[6], events$StartDate[7]) ~ events$ID[6],
    DateTime %within% interval(events$StartDate[7], events$StartDate[8]) ~ events$ID[7],
    DateTime %within% interval(events$StartDate[8], "2019-01-25") ~ events$ID[8],
    DateTime %within% interval(events$StartDate[9], events$StartDate[10]) ~ events$ID[9],
    DateTime %within% interval(events$StartDate[10], events$StartDate[11]) ~ events$ID[10],
    DateTime %within% interval(events$StartDate[11], events$StartDate[12]) ~ events$ID[11],
    DateTime %within% interval(events$StartDate[12], events$StartDate[13]) ~ events$ID[12],
    DateTime %within% interval(events$StartDate[13], events$StartDate[14]) ~ events$ID[13],
    DateTime %within% interval(events$StartDate[14], events$StartDate[15]) ~ events$ID[14],
    DateTime %within% interval(events$StartDate[15], events$StartDate[16]) ~ events$ID[15],
    DateTime %within% interval(events$StartDate[16], events$StartDate[17]) ~ events$ID[16],
    DateTime %within% interval(events$StartDate[17], events$StartDate[18]) ~ events$ID[17],
    DateTime %within% interval(events$StartDate[18], "2019-03-01") ~ events$ID[18]
             )  )
...
results <- results %>% 
  ...
  mutate(event_ID =
    ...
    Date %within% interval(events$StartDate[9], events$StartDate[10]) ~ events$ID[9],
    ...
    Date %within% interval(events$StartDate[18], "2019-03-01") ~ events$ID[18]
             )  ) %>% 
  # add seasons
