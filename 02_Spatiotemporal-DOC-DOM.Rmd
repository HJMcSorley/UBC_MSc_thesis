...
# Maybe -- replace this with a plot of ALL sites and move this into Ch3 with a similar plot for stage
...
Molecular aromaticity is associated with chromophores which are responsible for UV-Vis absorbance in aqueous NOM, therefore more aromatic NOM molecules (i.e., humic substances) will absorb more energy at 254 nm wavelength than less-aromatic molecules. To evaluate if - and when - molecular character of river samples may have shifted, DOC concentrations (NPOC) were compared to absorbance-based DOC estimates (Figure \@ref(fig:seasonalDOCest)). 
