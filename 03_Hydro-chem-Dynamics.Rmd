...
##### Spatiotemporal patterns in DOC & NOM
...
Longer wet season periods relative to dry season and collection of event-based samples lead to the wet season being more heavily sampled (Table \@ref(tab:seasonalsamples)). Despite seasonal sample count differences, interesting seasonal differences emerged when sample results were grouped by season (Figure \@ref(fig:seasonalNOM)). 

DOC concentrations decreased from headwaters to mouth (Tunnel) in both the wet and dry seasons, with the greatest variance at the head (Weeks) and mouth. 

NOM molecular character was ......

aromaticity was judged with specific UV-absorbance at 254 nm (SAC~254~), SUVA~254~ (L mg^-1^ m^-1^), and the quotient E~2~:E~3~ (unitless); these indices indicated that Weeks (site 1) had much greater dry-season aromaticity compared to the other sites. Aside from Weeks, which may have had higher summer aromaticity due to drainage from Weeks Lake and surrounding wetlands, aromatic character of NOM decreased from head to mouth during the dry season.   
