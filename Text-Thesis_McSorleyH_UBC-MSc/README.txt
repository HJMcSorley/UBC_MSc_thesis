These files are the plain text components of Hannah McSorley's thesis.

Refer to the file "Layout_thesis-structure" for a roadmap of how these components fit together (slight deviations may exists in the final product).
