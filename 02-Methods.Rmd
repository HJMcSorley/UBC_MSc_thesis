...
fig_cap = "*Overview of the Leech and Sooke Water Supply Areas (Greater Victoria, CRD), located on southeastern Vancouver Island, British Columbia, Canada. The overveiw of Canada illustrates precipitation of an atmospheric river event common to the west coast. The map (top) was generated in QGIS, and the image of Canada (bottom) and inset of Vancouver Island are screenshots from the Windy app (Windy.com).*"
