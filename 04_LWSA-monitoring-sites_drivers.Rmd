...
While there was a small amount of poorly-draining terric mesisol (undifferentiated organic soil) in the Weeks Creek sub-basin, soils were predominantly well-draining podzolic in the Leech (Table \@ref(tab:WTScharacterSubbasinTable)). Primarily, soils were either more acidic orthic humo-ferric podzol (O-HFP, pH < 5.6) or more neutral duric humo-ferric podzol (DU-HFP, pH 5.6 - 7.4). The major materials were colluvial deposits (O-HFP) and till (morainal, either DU-HFP or O-HFP).
