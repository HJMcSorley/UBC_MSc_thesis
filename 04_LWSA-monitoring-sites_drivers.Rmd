...
Rain was important for each of the three variables evaluated though RF VIM. Across the Leech WSA, the highest DOC occurred in the earliest events of each wet season (events 1 & 9, Table @\ref(tab:EventsTab)), while SAC~254~ peaked slightly after in the 2019/2020 wet season (events 10 & 11, Table @\ref(tab:EventsTab)). E~2~:E~3~ indicated maximum aromaticity and molecular size occured in late-season events (events 3 & 17, Table @\ref(tab:EventsTab)).
...
fig_cap = "\\label{fig:RFplot} Antecedent 7-day air temperature as a predictor variable for concentrations of dissolved organice carbon in the wet and dry seasons of the Leech Water Supply Area (including loess trend line)."
...
fig_cap = "\\label{fig:E3n4} "

knitr::include_graphics("Ch4_RF_E2E3-predictor-3n4-Trees-Logging")
```
...
___...not sure about this section... perhaps try a similar local extrema thing with SAC~254~ and or E~2~:E~3~??...___
...
Streams responded harmoniously to precipitation across the Leech WSA, with synchronous changes in stage, but was a similar harmony present for fluctuations in DOC or spectral properties? 
