...
# --
# isolate peaks
stage_samples_pks <- stage_samples_norm %>% 
  ...
  summarise(DateTime_peak_stage = DateTime[which.max(corr_stage_cm)],
            ...
            DateTime_peak_DOC = DateTime[which.max(NPOC_ppm)],
            peak_DOC = max(NPOC_ppm),
            DateTime_peak_SAC254 = DateTime[which.max(SAC254_Abs.m)],
