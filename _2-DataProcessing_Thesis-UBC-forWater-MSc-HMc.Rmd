...
metalslab %>% 
  ...
  write_csv("R-outputs_UBC-forWater-MSc_HMc/tables/metals-doc_correlations.png")
...
treatdat_UW <- 
  ...
  purrr::map_dfr(~ read_csv(
    file.path("R-inputs_UBC-forWater-MSc_HMc/Treatability-results_UW/", .), 
                            col_names = TRUE, skip = 15)) 

# isolate my results for these samples
treatdat_UBC 
a <- sampleresults %>% 
  mutate(Date = as_date(DateTime_sampled)) %>% 
  filter(sample_type == "Grab", analysis == "DOC",
         Date %within% interval("2020-02-17", "2020-02-21"),
         site == "Tunnel"|
           site == "Rithet"|
           site == "Judge" |
           site == "Deception-res") %>% 
