...
# isolate my results for these samples
...
# plot DOC and THM-FP
treatdat %>% 
  ggplot(aes(x = DOC_ppm, y = THMsfp_ugL))+
...
# plot DOC and TCM-FP
treatdat %>% 
  ggplot(aes(x = DOC_ppm, y = TCMfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
...
### BDCM-FP 
```{r}
# plot DOC and BDCM-FP
treatdat %>% 
  ggplot(aes(x = DOC_ppm, y = BDCMfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "DOC (mg/L)", y = "BDCM-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and HAA-FP
treatdat %>% 
  ggplot(aes(x = DOC_ppm, y = HAAsfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
...
### DCAA-FP
```{r}
# plot DOC and DCAA-FP
treatdat %>% 
  ggplot(aes(x = DOC_ppm, y = DCAAfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "DOC (mg/L)", y = "DCAA-FP (ug/L)",
       colour = "Sampling site")
...
### TCAA-FP 
```{r}
# plot DOC and TCAA-FP
treatdat %>% 
  ggplot(aes(x = DOC_ppm, y = TCAAfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "DOC (mg/L)", y = "TCAA-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and THM-FP
treatdat %>% 
  ggplot(aes(x = `UV254_cm-1`, y = THMsfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "UV254 (abs/cm)", y = "THM-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and TCM-FP
treatdat %>% 
  ggplot(aes(x = `UV254_cm-1`, y = TCMfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "UV254 (abs/cm)", y = "TCM-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and BDCM-FP
treatdat %>% 
  ggplot(aes(x = `UV254_cm-1`, y = BDCMfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "UV254 (abs/cm)", y = "BDCM-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and HAA-FP
treatdat %>% 
  ggplot(aes(x = `UV254_cm-1`, y = HAAsfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "UV254 (abs/cm)", y = "HAA-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and DCAA-FP
treatdat %>% 
  ggplot(aes(x = `UV254_cm-1`, y = DCAAfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "UV254 (abs/cm)", y = "DCAA-FP (ug/L)",
       colour = "Sampling site")
...
# plot DOC and TCAA-FP
treatdat %>% 
  ggplot(aes(x = `UV254_cm-1`, y = TCAAfp_ugL))+
  geom_point(aes(colour = site,
                 shape = Collection),
             size = 3.5)+
  scale_colour_brewer(palette="Set2") +
  ...
  theme(text = element_text(size = 12),
        legend.position = "right")+
  labs(x = "UV254 (abs/cm)", y = "TCAA-FP (ug/L)",
       colour = "Sampling site")
