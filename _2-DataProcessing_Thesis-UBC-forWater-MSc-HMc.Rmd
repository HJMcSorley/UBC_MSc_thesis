...
Ha: each subbasin has a greater range in concentrations than the range observed at the watershed outlet (Tunnel site)
Ho: there is no difference in the range observed at each subbasin site compared to the outlet.
