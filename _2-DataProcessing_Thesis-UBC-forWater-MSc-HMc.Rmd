...
synopticfilter <- sampleresults %>%
  ...
  mutate(site = factor(site, # order as you want to see them in plots
                       levels = c("West-Jordan", "Weeks", "ChrisCrk", "LeechHead", "Jarvis", "Lazar", "CraggCrk", "WestLeech", "Leech-downstreamconf", "Tunnel", "Rithet", "Judge", "Deception-res", "Deception", "Boneyard" ))) 
# rename funky names
