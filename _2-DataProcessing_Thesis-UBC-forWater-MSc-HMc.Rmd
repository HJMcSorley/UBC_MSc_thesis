...
RF_plot_relimp_MSE <- randomForest::importance(RF_NPOC, type = 1) %>% 
  ...
  theme_bw() +
  labs(y = "Relative importance", x = "", size = 11, 
       caption = "Importance of variables in predicting DOC, measured by type 1 (mean square errors, \n ie., mean decrease in accuracy when variable was omitted).")
# save it
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/RF_NPOC-relimp_type1-MSE.png", 
       width = 5, height = 4, units = "in")
...
RF_plot_relimp_RSE <- randomForest::importance(RF_NPOC_surface, type = 2) %>% 
  ...
  labs(y = "Relative importance", x = "", size = 11, 
       caption = 
         "Importance of variables in predicting DOC, measured by type 2 (residual sum of squares, \n ie., mean decrease in node impurity when variable was omitted).")
# save this one too 
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/RF_NPOC-relimp_type2-RSS.png",
       width = 5, height = 4, units = "in")


# arrange side by side
cowplot::plot_grid(RF_plot_relimp_MSE, RF_plot_relimp_RSE, nrow = 1)
