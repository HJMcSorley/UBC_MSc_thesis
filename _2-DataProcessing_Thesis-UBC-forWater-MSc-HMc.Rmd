...
# Sample subset df + sample counts
...
## WIP plot: DOC over time by site
...
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/DOC-over-time_subbasins_by-sampletype.png", 
       width = 4, height = 6, units = "in") 

# maybe try this with stage as a line and plot NPOC points by size (concentration)
```

# Seasonal DOC & DOM dynamics 

## plot : DOC seasonal subbasin Ridge plots
