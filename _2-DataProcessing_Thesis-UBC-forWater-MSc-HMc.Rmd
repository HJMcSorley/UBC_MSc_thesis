...
#### synchrony within sites: of peak DOC & stage 
```{r}
...
coincident_peaks <- sixfilter %>%
  ...
  summarise(max_stage = max(sampleStage_cm), # maximum stage sampled
            ...
            # eventID 
            eventID_max_stage = event_ID[first(which.max(sampleStage_cm))],
...
# subset for narrower window of well-sampled rain events
...
# check
coincident_proportion_sites
coincident_proportion_all
...
# you are here -- just finished the above
