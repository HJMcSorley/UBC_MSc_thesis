...
# damn t-tests (use Wilcoxon Rank Sum in case data is not normally distributed)
...
Hobo <- 
  ...
  purrr::map_dfr(~ read_csv(
    ...
    col_names = TRUE, skip = 1), .id = "source") 

# update
Hobo <- Hobo[1:4] # drop serial numbers
names(Hobo) <- c("source", "num", "DateTime", "Temp_C")
