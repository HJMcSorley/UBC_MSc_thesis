...
HT_Hobo_L %>% 
  ...
  # both 10 minute temp and daily mean
  geom_line(aes(colour = Temp, size = Temp))+
  scale_colour_manual(values = c(forWater_colours2[["SkyBlue"]], 
                                 forWater_colours2[["DeepBlue"]]),
  ...
  # horizontal lines for "refrigerator" range (0-7 C)
  ...
  annotate("text", label = c("Hold-time set:\n", paste(HT_dates$HoldTime_set, "\n")), 
           ...
           y = 27)+
  # label time lapse for each set (same x positions, lower down)
...
# save
ggsave("R-outputs_UBC-forWater-MSc_HMc/figures/HoldTime_ai-Temp.png")
