...
# subbasin_Hobos
subbasin_df <- read_csv("R-outputs_UBC-forWater-MSc_HMc/wrangled_dataframes/Subbasin_Results_complete.csv", 
                        col_names = TRUE) %>% 
...
### WIP!! Hobo with subbasin stage_sample results
```
#{r}
a <- Hobo %>% 
...
#### plot: subbasin Box seasonal DOC
```{r}
...
#### plot: subbasin Ridge seasonal DOC
```{r}
