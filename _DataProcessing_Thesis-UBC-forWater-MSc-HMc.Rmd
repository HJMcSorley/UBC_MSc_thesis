...
write_csv(n_subbbasinSamples, 
          path = "R-outputs_UBC-forWater-MSc_HMc/summary_subbasin-SampleCount.csv", na = "NA") 
...
In total 400 samples were collected (\@ref(tab:sample-summary-table))
...
tibble::tibble(
  ...
  write_csv("R-outputs_UBC-forWater-MSc_HMc/tables/summary-sample-count-table.csv")
...
```{r, DOCspace, fig.width=7, fig.height=5, echo = FALSE}
