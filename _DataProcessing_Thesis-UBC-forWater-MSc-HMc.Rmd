...
# replace_na(data = sampleresults$SUVA, replace = sampleresults$pseudoSUVA)
...
tibble::tibble(
  ...
  write_csv("R-outputs_UBC-forWater-MSc_HMc/sample-summary-table.csv")
...
sampleresults %>% 
  ...
  ggplot(aes(x = trip_end, y = pseudo_SUVA, fill = two_seasons)) +  
  geom_jitter(shape = 21, size = 3, alpha = 0.6) +
  scale_fill_manual(values = c("#f4AB0E", "#09A4D2")) +
  theme_bw() +
