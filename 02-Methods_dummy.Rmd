...
knitr::opts_chunk$set(include=FALSE, fig.path="R-outputs_UBC-forWater-MSc_HMc/figures/")
...
<br>
```{r LeechWxPlot, echo = FALSE, fig.cap='(ref:LeechWxPlot)'}
# stack precip and temp with cowplot
cowplot::plot_grid(rainplot, tempplot, ncol = 1, align = "v")
```
<br>

There is a weather station on the Malahat mountain pass, east of the study site (ID 62091, BC Ministry of Transportation and Infrastructure and Pacific Climate Impacts) that had precipitation and air temperature data available from 2014 to 2020. 


(ref:MalahatWxPlot) shows weather data from the Malahat weather station and highlights the period in which this research occurred in which there were no obvious deviations from previous years.

 
 <br>
```{r MalahatWxPlot, fig.cap='(ref:MalahatWxPlot)', echo = FALSE, fig.cap="Weather patterns recorded on the Malahat, east of the study site. Highlighted sections indicate the period of this study."}
