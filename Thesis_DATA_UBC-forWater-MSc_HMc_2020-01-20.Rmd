...
## Shimadzu TOC-V for DOC concentrations (as NPOC)
...
## Spectrolyser proxy analysis results (DOC, TOC, NO3-, SAC254, SAC436)
...
# assign column names
fullscan_colnames <- c("Date", "Time", "Status", seq(200.0, 750.0, by = 2.5))
## read in files and add a column indicating trip #, based on source file name
...
## Join results files from Shimadzu and Spectrolyser (direct and indirect measures of DOC)
