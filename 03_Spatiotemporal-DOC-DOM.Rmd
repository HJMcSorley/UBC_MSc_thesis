...
Despite DOC changes over time, there was almost no difference between mean DOC concentrations during the wet and dry seasons (6.13 mg/L compared to 6.14 mg/L). However, there were far fewer DOC samples collected in the dry season (55) than during the wet season (311).  Similarly, there were more spectral NOM characteristic samples collected in the wet season than the dry (Table \@ref(tab:seasonalSummary)). Higher SAC~254~ values in the wet season indicated greater aromaticity and NOM reactivity than was observed in the dry season.
