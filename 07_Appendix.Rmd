...
#######  Leech River Watershed Site Details
...
######## Air temperature comparison & linear regression 
...
```
# I think all of this could be deleted oir moved)
#########   Installation / monitoring sites
...
######### forWater-coordinated treatability analyses sites
...
######### Sampling for Metals on behalf of the CRD
...
Each sample that was analyzed on the Spectrolyser resulted in an estimate of DOC and nitrate concentrations based on sample UV-Vis light absorption. Estimated concentrations of nitrate were positively related to DOC concentration and UV-absorbance based estimates of DOC concentration were more strongly correlated to nitrate estimates (Figure \@ref(fig:nitrate)). Nitrate can be a spectroscopic interferant for DOM estimates, and it's unclear how the spectrolyser destinguishes between the two.

\  

```{r nitrate, out.width = "100%", fig.pos="h", fig.cap = fig_cap}
