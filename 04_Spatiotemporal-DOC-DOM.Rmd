...
The methods defined in Chapter 2 were used to collect and analyze surface water samples with the objective of describing spatial and temporal patterns and variation of DOC concentrations and NOM character across the Greater Victoria water supply area (GVWSA, refer to Chapter 2, Figure \@ref(fig:sampleSitesMap) for map). Additionally, interpretation of results saught to identify the influence of seasonality on concentration of DOC and character of NOM.
