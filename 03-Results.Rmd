...
```{r MinMaxEvents}
read_csv("R-outputs_UBC-forWater-MSc_HMc/tables/Wx_Events_min-max.csv") %>% 
...
Mean FWx temperatures were referenced and compared to air temperatures measured at each research site.
