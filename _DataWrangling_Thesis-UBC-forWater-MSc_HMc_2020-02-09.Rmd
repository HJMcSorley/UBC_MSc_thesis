...
S1 <- S1 %>% 
   ...
   mutate(sample_slope = coef(lm(data = S1, formula = lnSAC ~ wavelength_nm))[[2]])

S1 %>% ggplot(aes(x = wavelength_nm, y = lnSAC)) +
  geom_jitter() +
